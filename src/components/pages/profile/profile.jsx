...
import { updateProfileHandler, fetchProfileHandler } from './profile-handlers';
...
const Profile = () => {
    ...
    return (
        <Container fluid className="p-0">
            ...
            <Form onSubmit={(e)=>updateProfileHandler(e,nameRef.current.value, photoRef.current.value)} className="ps-3">
